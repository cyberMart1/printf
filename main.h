...
/*
 * typedef struct fmt fmr_t - struct op
 *
 * @fmt: the format
...
int print_hexa(va_list types, char map_to[], char buffer[],
                int flags, int width,char flag_ch, int precision, int size);

/* functions to print non printable characters */
int print_non_printable(va_list types, char buffer[],
                int flags, int width, int precision, int size);

/* function to print memomey address */
int print_pointer(va_list types, char buffer[],
                int flags, int width, int precision, int size);

/* function to handle other specifeiers */
...
int write_number(int is_positive, int ind, char buffer[],
                int flags, int width, int precision, int size);
int write_num(int ind,char buff[], char padd, char extra_c,
                int flags, int width, int lenght, int precision, int size);
int write_pointer(char buffer[], int ind, int lenght, char padd, char extra_c,
		int flags, int width, int precision, int size, int padd_start);
